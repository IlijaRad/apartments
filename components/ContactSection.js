...
const ContactSection = () => {
  return (
    <div id="contact" className="px-6 pt-12 lg:px-12 lg:pt-[166px] ">
      ...
      <div className="mx-auto grid max-w-lg gap-8 pt-20 md:max-w-4xl md:grid-cols-2">
        <LocationSection />
        <div className="border border-gray-200 py-12">
          ...
          <div className="mx-auto grid max-w-[240px] grid-cols-[90px_1fr] items-center justify-center pt-20">
